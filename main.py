...
store_name_map = {
    ...
    '5d320e27-c8a2-4396-8d1c-a29672bd9b57': 'Med Mall SB'
}
...
def generate_ratio_anomalies(client, store_map):
    ...
    ReceiptItemsInRange AS (
        SELECT created_at, store_id,
               JSON_EXTRACT_SCALAR(item, '$.item_name') AS name,
        ...
        WHERE created_at >= TIMESTAMP_SUB(CURRENT_TIMESTAMP(), INTERVAL {BASELINE_DAYS} DAY)
          AND JSON_EXTRACT_SCALAR(item, '$.item_name') IN ("Americano", "SB Spanish")
    )
